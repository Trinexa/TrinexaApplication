/*
  # Fix Invalid UUID Error in Email Templates

  This script will:
  1. Delete any templates with invalid 'system' created_by value
  2. Re-insert the correct email templates with NULL created_by
*/

-- Delete any templates that have invalid created_by values
DELETE FROM email_templates 
WHERE name IN ('Job Application Confirmation', 'General Application Confirmation')
AND category = 'transactional';

-- Insert Job Application Confirmation Template (fixed)
...
-- Insert General Application Confirmation Template (fixed)
INSERT INTO email_templates (name, category, subject, content, variables, is_active, usage_count) VALUES
...
-- Verify the templates were inserted correctly
SELECT name, category, created_by, created_at
FROM email_templates 
WHERE category = 'transactional' 
AND name IN ('Job Application Confirmation', 'General Application Confirmation');
