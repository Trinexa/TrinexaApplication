...
{{#if_client}}
We look forward to showing you {{product_interest}} capabilities.
{{/if_client}}
...
Best regards,
Trinexa Team',
'["recipient_name", "scheduled_date", "scheduled_time", "timezone", "google_meet_link", "role_in_demo", "preparation_notes", "product_interest"]')
...
SELECT 'DEMO SESSION MANAGEMENT SETUP COMPLETE!' as result;
